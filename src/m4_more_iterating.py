...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [5,3,2,1,4,.0000000001,-1]
    threshold = 0
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 9
    actual = count_positive_sines([1.57, 2, 3, 1.57, 2, 3, 1.57, 2, 3])
    print()
    print('Test 10 expected:', expected)
    print('        actual:  ', actual)
    ...
    # Test 12
    expected = 0
    actual = count_positive_sines([-1.57, 6, 61])
    print()
    print('Test 10 expected:', expected)
    print('        actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # ------------------------------------------------------------------
    # TO DO: 8. Implement this TEST function.
